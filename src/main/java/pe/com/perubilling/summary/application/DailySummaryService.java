...
public class DailySummaryService {
    ...
    /**
     * Ruta interna utilizada por la automatización multi-tenant. No depende del SecurityContext.
     * Devuelve empty si otro nodo ya tomó los documentos o no quedan CPE pendientes.
     */
    @Transactional
    ...
    private Optional<DailySummaryResponse> createInternal(
        ...
        // Debe ocurrir ANTES de leer los pendientes. De lo contrario dos nodos pueden
        // construir resúmenes a partir de la misma fotografía obsoleta.
