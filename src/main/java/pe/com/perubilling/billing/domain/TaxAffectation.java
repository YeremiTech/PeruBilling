...
public enum TaxAffectation {
    ...
    /**
     * Esquema tributario que corresponde a la línea del comprobante. La gratuidad
     * no reemplaza la afectación real del Catálogo 07: una transferencia gratuita
     * gravada sigue reportando IGV (1000), una exonerada 9997 y una inafecta 9998.
     * El total de operaciones gratuitas se informa por separado con el esquema 9996.
     */
    ...
    /**
     * Categoría tributaria UN/ECE 5305 usada por SUNAT en UBL 2.1.
     * S=gravado, E=exonerado, O=inafecto y G=exportación.
     * El total agregado de operaciones gratuitas usa Z y se resuelve en UblGenerator.
     */
