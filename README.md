...
Crear series para factura, boleta y notas.

En LOCAL, emitir sin certificado ni SUNAT.

En BETA o PRODUCTION, configurar credenciales SOL.

Cargar certificado PKCS#12 vigente.

Instalar XSD oficiales UBL 2.1 y 2.0 con checksums fijados usando scripts/download-sunat-xsd.sh.

Ejecutar mvn clean verify con JDK 25 + Docker/Testcontainers.

Ejecutar casos oficiales en BETA antes de producción.
