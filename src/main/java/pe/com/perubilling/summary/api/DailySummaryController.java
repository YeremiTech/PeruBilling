...
public class DailySummaryController {
    ...
    @PostMapping("/{id}/retry-unknown")
    @PreAuthorize("hasAnyRole('ADMIN','OPERATOR') or hasAuthority('SCOPE_DOCUMENT_WRITE')")
    @Operation(summary = "Reintenta manualmente un Resumen Diario con envío de resultado desconocido")
    public DailySummaryResponse retryUnknown(
