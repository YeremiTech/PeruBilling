...
@Entity
@Table(name = "voiding_batch")
public class VoidingBatchEntity extends BaseEntity {
    ...
    @Enumerated(EnumType.STRING) @Column(nullable=false,length=30) private VoidingBatchStatus status;
    ...
    public LocalDate getGenerationDate(){return generationDate;} public void setGenerationDate(LocalDate v){generationDate=v;}
    ...
    public VoidingBatchStatus getStatus(){return status;} public void setStatus(VoidingBatchStatus v){status=v;}
