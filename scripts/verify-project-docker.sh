...
# Testcontainers se ejecuta dentro del contenedor Maven y crea contenedores hermanos
# mediante el socket del host. host.docker.internal permite resolver los puertos
# publicados por esos contenedores desde Linux/macOS/Windows modernos.
docker run --rm \
